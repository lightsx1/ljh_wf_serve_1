...
public class TagServiceImpl extends DemandDiImpl implements TagService {
    ...
    public String deleteTag(String id) throws StatusException {
        ...
        ResultPage< ? extends Demand> rp = searchDemandByTagId(id);
//
//
...
//        tagPersister.get(id).deleteTag();
    ...
    @Override
    public ResultPage<DemandImpl> searchDemandByTagId(String id) {

        ResultPage< DemandImpl >  rp = demandPersistent.search(
          ConditionUtil.eq(ConditionUtil.field("tag"),id)
        );
